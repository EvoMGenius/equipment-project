...
public class AuthenticationService {
     ...
     */
    public OAuth2AccessToken login(@NonNull String username) {
    ...
    private OAuth2AccessToken createAccessToken(Map<String, String> params, User user) {
        ...
        PreAuthenticatedAuthenticationToken token = new PreAuthenticatedAuthenticationToken(userDetails, null, authorities);
